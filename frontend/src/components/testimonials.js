    ...
    <div>
      <div className="bg-white pt-16 pb-12">
        <div class="container my-24 px-6 mx-auto">
          <section class="mb-32 text-gray-800 text-center md:mb-12">
            ...
            <div class="grid md:grid-cols-3 gap-x-6  lg:gap-x-12">
              <div class="mb-12 md:mb-0">
                ...
                <h5 class="text-lg font-bold mb-4">Joey Tribbiani</h5>
              ...
              <div class="mb-12 md:mb-0">
                ...
                <h5 class="text-lg font-bold mb-4">Rachel Green</h5>
              ...
              <div class="mb-0">
                ...
                <h5 class="text-lg font-bold mb-4">Chandler Bing</h5>
                <h6 class="font-medium text-blue-600 mb-4">UI/UX Designer</h6>
                <p class="mb-4">
